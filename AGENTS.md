...
5. **인위적인 박스/카드 디자인 지양 (Clean Minimal Typography Policy)**:
   - 안내 문구, 알림 텍스트 등에 인위적인 테두리 박스, 배너 카드, 뱃지 상자(`box/card`)를 남발하지 않습니다.
   - 불필요한 박스 디자인을 전면 배제하고, 깔끔하고 우아한 타이포그래피(폰트 굵기, 색상, 자간, 여백)를 통해 자연스럽게 가독성과 강조를 구현합니다.
